...
{
  $Gapp::Gtk2::Model::SimpleList::VERSION = '0.482';
}
...
<Gapp::Gtk2::SimpleList> is a very simpleL<Gtk2::TreeModel|http://library.gnome.org/devel/gtk/stable/GtkTreeModel.html>
...
=item  +-- Gapp::Gtk2::Model::SimpleList
